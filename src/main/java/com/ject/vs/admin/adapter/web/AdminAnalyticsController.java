...
/**
 * 어드민 이벤트 분석 화면(Thymeleaf). 기간 + 지표(다중 선택) + 쪼개서 보기 조건을
...
public class AdminAnalyticsController {
    ...
    public String page(@AuthenticationPrincipal Long userId,
        ...
        LocalDate[] range = adminAnalyticsService.clampRange(
                parseOrDefault(from, today.minusDays(DEFAULT_RANGE_DAYS)),
                parseOrDefault(to, today));
